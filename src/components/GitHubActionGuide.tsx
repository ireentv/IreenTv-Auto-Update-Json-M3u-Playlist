...
export const GitHubActionGuide: React.FC<GitHubActionGuideProps> = ({ sourceUrl, branding }) => {
  const [playlists, setPlaylists] = useState<PlaylistItem[]>([
    ...
    {
      "name": "World_Movies",
      "url": "https://raw.githubusercontent.com/famelack/famelack-data/main/tv/raw/categories/movies.json"
    },
    {
      "name": "Live_Sports",
    ...
    {
      "name": "Music_World",
      "url": "https://raw.githubusercontent.com/famelack/famelack-data/main/tv/raw/categories/music.json"
    },
    {
      "name": "tapmad_bd",
    ...
    },
    {
      ...
      "url": "https://raw.githubusercontent.com/srhady/toffee-bd/main/toffee_playlist.json"
    }
  ]);
...
def extract_urls_from_item(item):
    ...
    primary_keys = [
        ...
        'uri', 'm3u8', 'streamUrl', 'sources', 'streams', 'urls', 'links', 'src'
    ]
...
def parse_json_playlist(data):
    ...
    for item in target_array:
        ...
        group = "General"
        for k in ['group', 'category', 'genre', 'group-title', 'type', 'sportName', 'event_category', 'eventCategory', 'country']:
            if k in item:
                group = str(item[k])
                break
